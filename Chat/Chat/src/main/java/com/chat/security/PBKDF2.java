...
/**
 * This is implementation of Password-Based Key Derivation Function 2 (PBKDF 2) on java
 * com.chat.security.PBKDF2 applies a pseudorandom function, such as a cryptographic hash, cipher,
 * or HMAC to the input password or passphrase along with a salt value and repeats the process many times
 ...
 * and means that multiple passwords have to be tested individually, not all at once.
 * The standard recommends a salt length of at least 64 bits
 *
 * General view:
 * DK = com.chat.security.PBKDF2(PRF, Password, Salt, c, dkLen), where
